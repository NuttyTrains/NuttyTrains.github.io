...
var x = setInterval(function() {
  ...
  document.getElementById("countdown").innerHTML = " The UK has approx. " + chock + " chock cases. We're all going to die. Reality is an illusion, the universe is a hologram, buy toilet roll!";
},1000);
